...
print("----------------1.3、列表的嵌套-------------------------")
# 8.列表的嵌套使用：类似于多维数组
name_list = [['tom', 'lily', 'juhnko'], ['张三', '李四', '王五'], [123, 456, 789],3,4,5,6,7]
print(name_list[1][2])
print("----------------1.4、列表的切片-------------------------")
#口诀：[start:end:step]
# 切片其实很简单，只顾头尾不管，步长为正，则正向移，步长为负，则逆向移
print(name_list[0:2])# 切片, 切片的格式为：[起始索引：结束索引：步长], 默认的步长为1，从索引0开始到索引2-1结束。
print(name_list[0:7:2]) # 切片，步长为2
print(name_list[2:-2])# 切片，包含结尾，步长为-2
print(name_list[-1:-8:-2]) # 切片，包含结尾，步长为-2
...
print("---------------------------2.3、元组的切片--------------------")
print(t1)
print(t1[0:2])# 切片，切片的格式为：[起始索引：结束索引：步长], 默认的步长为1，从索引0开始到索引2-1结束。
